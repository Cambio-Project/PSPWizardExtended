...
public class MaximumDurationPanel extends javax.swing.JPanel implements PatternPanelFeatures
{
    private PSPController fPSPController;
    private MaximumDuration fSelectedPattern;
    ...
    {
        if ( aSelectedPattern instanceof MaximumDuration )
        {
            fSelectedPattern = (MaximumDuration)aSelectedPattern;
    ...
    public MaximumDurationPanel() 
    {
        initComponents();
        
        fSelectedPattern = new MaximumDuration();
    ...
    {
        setSelectedPattern( new MaximumDuration() );
    }
    ...
    private void initComponents() {
        ...
        jLabel16.setText("it remains so for less than");
