...
public class ExistencePanel extends javax.swing.JPanel implements PatternPanelFeatures
{
    private PSPController fPSPController;
    private Existence fSelectedPattern;
    ...
    {
        if ( aSelectedPattern instanceof Existence )
        {
            fSelectedPattern = (Existence)aSelectedPattern;
    ...
    public ExistencePanel() 
    {
        initComponents();
        
        fSelectedPattern = new Existence();
    }

    public void clearSelection()
    {
        setSelectedPattern( new Existence() );
    }
