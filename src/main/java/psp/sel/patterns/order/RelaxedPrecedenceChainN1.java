...
public class RelaxedPrecedenceChainN1 extends Order
{
    ...
    public RelaxedPrecedenceChainN1()
    {
        this( EventImpl.getDefault(), EventImpl.getDefault(), new ChainEvents(), null, null, null );
    }

    public RelaxedPrecedenceChainN1(EventImpl aEventP, EventImpl aEventS, ChainEvents aEventTis,
    ...
    public int getType() 
    {
        return PSPConstants.P_RelaxedPrecedenceChainN1;
    }
    ...
    public String getSpecificationAsSEL() 
    {
        ...
        sb.append( getTis().getSpecificationAsSEL( " and then " ) );
