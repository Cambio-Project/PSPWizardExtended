...
public class RelaxedPrecedenceChain1N extends Order
{
    ...
    public RelaxedPrecedenceChain1N()
    {
        this( EventImpl.getDefault(), EventImpl.getDefault(), new ChainEvents(), null, null, null );
    }

    public RelaxedPrecedenceChain1N(EventImpl aP, EventImpl aS, ChainEvents aTis,
