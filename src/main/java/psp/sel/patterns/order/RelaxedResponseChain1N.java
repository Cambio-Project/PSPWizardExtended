...
public class RelaxedResponseChain1N extends Order
{
    ...
    public RelaxedResponseChain1N()
    {
        this( EventImpl.getDefault(), EventImpl.getDefault(), new ChainEvents(), null, null, null );
    }

    public RelaxedResponseChain1N(EventImpl aEventP, EventImpl aEventS, ChainEvents aEventTis,
    ...
    public int getType() 
    {
        return PSPConstants.P_RelaxedResponseChain1N;
    }
