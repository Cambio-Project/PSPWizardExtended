...
public class RelaxedResponseChainN1 extends Order
{
    ...
    public RelaxedResponseChainN1()
    {
        this( EventImpl.getDefault(), EventImpl.getDefault(), new ChainEvents(), null, null, null );
    }

    public RelaxedResponseChainN1(EventImpl aEventP, EventImpl aEventS, ChainEvents aEventTis,
    ...
    public int getType() 
    {
        return PSPConstants.P_RelaxedResponseChainN1;
    }
